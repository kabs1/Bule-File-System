...
<div class="card">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddCurrency" aria-labelledby="offcanvasAddCurrencyLabel">
    <div class="offcanvas-header border-bottom">
      <h5 id="offcanvasAddCurrencyLabel" class="offcanvas-title">Add Currency</h5>
      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
      <form id="addCurrencyForm" onsubmit="return false">
        ...
        <div class="mb-6 form-control-validation">
          <label class="form-label" for="currency-rate">Exchange Rate</label>
          <input type="number" step="0.0001" class="form-control" id="currency-rate" name="exchange_rate" />
        </div>
